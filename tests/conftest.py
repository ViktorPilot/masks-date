...
@pytest.fixture
def usual_transactions() -> list[dict]:
    return [
        {
            "id": 939719570,
            "state": "EXECUTED",
        ...
        },
        {
            ...
            "operationAmount": {"amount": "56883.54", "currency": {"name": "USD", "code": "EURO"}},
...
@pytest.fixture
def not_operations_usd() -> list[dict]:
    return [
        {
            "id": 939719570,
            "state": "EXECUTED",
            "date": "2018-06-30T02:08:58.425572",
            "operationAmount": {"amount": "9824.07", "currency": {"name": "RUB", "code": ""}},
            "description": "Перевод организации",
            "from": "Счет 75106830613657916952",
            "to": "Счет 11776614605963066702",
        },
...
@pytest.fixture
def get_dict_transactions_valid() -> list[dict]:
    return [
        {
            "id": 441945886,
            "state": "EXECUTED",
...
@pytest.fixture
def get_amount_transactions_rub() -> dict:
    return {
        "id": 441945886,
        "state": "EXECUTED",
        "date": "2019-08-26T10:50:58.294041",
...
def invalid_type_amount() -> dict:
    return {
        ...
        "state": "EXECUTED",
        "date": "2019-08-26T10:50:58.294041",
        "operationAmount": {"amount": "три тысячи", "currency": {"name": "руб.", "code": "RUB"}},
        "description": "Перевод организации",
        "from": "Maestro 1596837868705199",
        "to": "Счет 64686473678894779589",
    }
...
def get_amount_transactions_usd() -> dict:
    return {
        ...
        "state": "EXECUTED",
        "date": "2019-08-26T10:50:58.294041",
        "operationAmount": {"amount": "100.58", "currency": {"name": "долл.", "code": "USD"}},
        "description": "Перевод организации",
        "from": "Maestro 1596837868705199",
        "to": "Счет 64686473678894779589",
    }
...
def invalid_code_currency() -> dict:
    return {
        ...
        "state": "EXECUTED",
        "date": "2019-08-26T10:50:58.294041",
        "operationAmount": {"amount": "31957.58", "currency": {"name": "руб.", "code": "JPY"}},
        "description": "Перевод организации",
        "from": "Maestro 1596837868705199",
        "to": "Счет 64686473678894779589",
    }
...
@pytest.fixture
def valid_get_operation_csv() -> Tuple:
    return {
        "id": "650703",
        "state": "EXECUTED",
...
@pytest.fixture
def valid_get_operation_excel() -> list[dict]:
    return [
        {
            "id": 650703.0,
            "state": "EXECUTED",
