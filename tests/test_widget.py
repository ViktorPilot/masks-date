...
@pytest.mark.parametrize("data_card, result", [("Счет 64686473678894779589", "Счет **9589"),
...
@pytest.mark.parametrize("data_card", ["Счет 6468647367889",
                                       "Счет 000000000000000000001111",
...
@pytest.mark.parametrize("card_date, result", [("2024-03-11T02:26:18.671407", "11.03.2024"),
