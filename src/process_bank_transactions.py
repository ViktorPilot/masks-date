...
logging.basicConfig(filename=PATH_TO_LOGGER,
                    filemode="w",
...
def process_bank_operations(data: list[dict], categories: list) -> dict:
    """Функция, подсчитывающая количество транзакций по заданным категориям в описании"""
    logger.info("Начало работы функции..")
    list_filtred_cat = [operation.get("description", "") for operation in data if
                        operation.get("description", "") in categories]
    logger.info("Список с описанием всех проведенных транзакций создан.")
